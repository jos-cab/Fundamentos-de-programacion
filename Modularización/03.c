/*
3. Escribir un programa que solicite el ingreso de valores, que representarán
una cantidad de segundos.

El programa deberá informar al usuario, el equivalente en días, horas, minutos y
segundos.
...
void pedir_segundos(int *segundos)
{
    do
    {
        printf("Ingresa tiempo en segundos obtener su equivalente en días: ");
...
void calcular_tiempos(int segundos,
                      int *resto_segundos,
                      int *minutos,
                      int *horas,
                      int *dias)
